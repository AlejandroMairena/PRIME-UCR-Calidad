...
function CreateAppointmentsVsMedicalRecordsPressureComponentJS(results) {
    am4core.ready(function () {
        ...
        var chart = am4core.create("AppointmentsVsMedicalRecordsPressureComponent", am4charts.XYChart);
