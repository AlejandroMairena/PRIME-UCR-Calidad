...
VALUES
    ...
    ('11111111', 8, 2, 'Aéreo'),
    ('11111111', 9, 2, 'Aéreo'),
    ('11111111', 10, 3, 'Marítimo'),
    ('11111111', 11, 4, 'Marítimo'),
    ('11111111', 12, 5, 'Marítimo'),
    ('11111111', 13, 6, 'Aéreo'),
    ('11111111', 14, 7, 'Marítimo'),
    ('11111111', 15, 8, 'Marítimo'),
    ('11111111', 16, 9, 'Marítimo'),
    ('11111111', 17, 9, 'Terrestre'),
    ('11111111', 18, 9, 'Terrestre'),
    ('11111111', 19, 8, 'Terrestre'),
	('11111111', 20, 3, 'Terrestre'),
    ('11111111', 21, 4, 'Marítimo'),
    ('11111111', 22, 5, 'Marítimo'),
    ('11111111', 23, 1, 'Aéreo'),
    ('11111111', 24, 2, 'Terrestre'),
    ('11111111', 25, 2, 'Aéreo'),
    ('11111111', 26, 2, 'Terrestre'),
    ('11111111', 27, 4, 'Terrestre'),
    ('11111111', 28, 4, 'Marítimo'),
    ('11111111', 29,7, 'Aéreo'),
    ('11111111', 30, 8, 'Terrestre'),
    ('11111111', 31, 3, 'Terrestre'),
    ('11111111', 32, 2, 'Marítimo'),
    ('11111111', 33, 1, 'Terrestre'),
    ('11111111', 34, 4, 'Marítimo'),
    ('11111111', 35, 6, 'Terrestre'),
    ('11111111', 36, 5, 'Aéreo'),
    ('11111111', 37, 5, 'Terrestre'),
    ('11111111', 38, 5, 'Aéreo'),
    ('11111111', 39, 3, 'Aéreo'),
    ('11111111', 40, 2, 'Terrestre');
